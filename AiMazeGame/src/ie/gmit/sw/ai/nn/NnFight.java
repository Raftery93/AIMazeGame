...
public class NnFight {
	...
	public double[] action(double health, double weapon, double angerLevel) throws Exception{		
		...
		//Select which function suits the current play
		if(health > 5){
		...
		switch(choice){
		case 1:
			System.out.println("[INFO] Spider action: Panic");
			break;
		case 2:
			System.out.println("[INFO] Spider action: Attack");
			break;
		case 3:
			System.out.println("[INFO] Spider action: Hide");
			break;
		default:
			System.out.println("[INFO] Spider action: Running away");
		}
