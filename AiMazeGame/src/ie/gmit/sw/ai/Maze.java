...
public class Maze {
	...
	//An array does not lend itself to the type of mazge
	// generation algos we use in the labs.
	private Node[][] maze;
	private Node goal;
	private int goalPos;
	...
	//Create hedges around edges of matrix
	...
	public void setGoalNode() { // Randomly set the goal node.
	...
	protected void unvisit() {
	 ...
	 //Supposed to reduce the number of rooms, doesnt work
